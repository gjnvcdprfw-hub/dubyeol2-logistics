...
11. Machine Check 게이트: 별도 역할이 아니라 Team Leader가 Phase 종료 전 빌드, 테스트, 고객 예시, UI 깨짐, 콘솔 오류, 디자인 시스템 중 기계가 볼 수 있는 것을 먼저 확인하는 자동 검증 묶음이다. 결과는 `03-verification.md`에 남긴다.
